namespace ZoneEngine_New.Tests
{
    ...
    public sealed class NanoCastRulesTests
    {
        ...
        public void RechargeIsADeadlineThatExpiresOnItsOwn()
        {
            ...
            NpcCharacter player = new(new Identity { Type = IdentityType.CanbeAffected, Instance = 600 }, new StubItemBuilder());
        ...
        {
            var start = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc);
            NpcCharacter player = new(new Identity { Type = IdentityType.CanbeAffected, Instance = 601 }, new StubItemBuilder());
        ...
        {
            var start = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc);
            NpcCharacter player = new(new Identity { Type = IdentityType.CanbeAffected, Instance = 603 }, new StubItemBuilder());
