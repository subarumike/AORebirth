...
namespace LoginEngine.CharacterCreation
{
    ...
    /// <summary>
    /// Level-1 Enforcer starter inventory from capture 20260711-enforcer-starter-kit (FullCharacter slots 64-72).
    /// </summary>
    internal static class EnforcerStarterLoadout
    {
        ...
        private const int StarterLife = 60;
        private const int StarterHealth = 60;
        private const int StarterNano = 20;
        private const int StarterMaxNano = 20;
        ...
        private static readonly StarterItemDefinition[] Items =
        {
            ...
            new StarterItemDefinition { Placement = 70, LowId = 218406, HighId = 218406, Quality = 1, Count = 1 },
            new StarterItemDefinition { Placement = 71, LowId = 121564, HighId = 121564, Quality = 1, Count = 1 },
            new StarterItemDefinition { Placement = 72, LowId = 100202, HighId = 100202, Quality = 17, Count = 1 },
        };
