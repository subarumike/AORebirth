...
namespace LoginEngine.CharacterCreation
{
    ...
    /// <summary>
    /// Level-1 Martial Artist starter inventory from capture 20260711-MartialArtist-starter-kit (FullCharacter slots 64-72).
    /// </summary>
    internal static class MartialArtistStarterLoadout
    {
        ...
        private static readonly StarterItemDefinition[] Items =
        {
            ...
            new StarterItemDefinition { Placement = 71, LowId = 121565, HighId = 121565, Quality = 1, Count = 1 },
            new StarterItemDefinition { Placement = 72, LowId = 28943, HighId = 28943, Quality = 4, Count = 1 },
        };
