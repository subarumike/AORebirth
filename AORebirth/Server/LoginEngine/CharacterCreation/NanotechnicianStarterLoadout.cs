...
namespace LoginEngine.CharacterCreation
{
    ...
    /// <summary>
    /// Level-1 Nano-Technician starter inventory from capture 20260711-Nano-Technician-starter-kit (FullCharacter slots 64-72).
    /// </summary>
    internal static class NanotechnicianStarterLoadout
    {
        ...
        private const int StarterNano = 48;
        private const int StarterMaxNano = 48;
        ...
        private static readonly StarterItemDefinition[] Items =
        {
            ...
            new StarterItemDefinition { Placement = 70, LowId = 28815, HighId = 28815, Quality = 1, Count = 1 },
            new StarterItemDefinition { Placement = 71, LowId = 121567, HighId = 121567, Quality = 1, Count = 1 },
            new StarterItemDefinition { Placement = 72, LowId = 297665, HighId = 297665, Quality = 1, Count = 1 },
        };
