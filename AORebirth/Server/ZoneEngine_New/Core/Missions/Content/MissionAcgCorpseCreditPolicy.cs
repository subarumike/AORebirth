namespace ZoneEngine.Core.Missions
{
    ...
    {
        internal static int MinimumCredits => MissionArtifactContent.Current.MinimumCorpseCredits;
        internal static int MaximumCredits => MissionArtifactContent.Current.MaximumCorpseCredits;
