namespace ZoneEngine.Core.Missions
{
    ...
    {
        internal static int DropChancePercent => MissionContentJson.Read<int>("RareLootChancePercent.json");
        ...
        private static readonly RareDrop[] Drops = MissionContentJson.Read<RareDrop[]>("RareLoot.json");
