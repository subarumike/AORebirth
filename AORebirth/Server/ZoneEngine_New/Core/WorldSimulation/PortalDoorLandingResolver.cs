namespace ZoneEngine_New.Core.WorldSimulation
{
    ...
    public static class PortalDoorLandingResolver
    {
        ...
        public static bool TryResolveDoorLanding(PlayfieldGeometryData? geometry, int doorInstance,
            float clearance, out Vector3 landing, out Quaternion heading)
            => TryResolveLandingForType(geometry, doorInstance, (int)IdentityType.Door, clearance, out landing, out heading);
