namespace ZoneEngine.Core
{
    ...
    /// Same data as ChatEngine <c>TeamLevelRanges</c>.
    /// Live-matched: out-of-window invites are not delivered to the invitee.
    /// Client Recruit TooHigh/TooLow warn is separate (GUI.dll) and cannot be cleared here.
    /// </summary>
