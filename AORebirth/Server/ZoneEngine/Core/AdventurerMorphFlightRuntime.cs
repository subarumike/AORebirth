namespace ZoneEngine.Core
{
    ...
    public static class AdventurerMorphFlightRuntime
    {
        ...
        private static readonly byte[] SparrowApplyWire = MorphCaptureWireCatalog.GetWire(82835, false);

        private static readonly byte[] SparrowRemoveWire = MorphCaptureWireCatalog.GetWire(82835, true);

        // Capture 20260806-085523 IN SpellList after FinishNanoCasting 270542.
        private static readonly byte[] PhasefrontCamoApplyWire = MorphCaptureWireCatalog.GetWire(270542, false);

        // Capture 20260806-081845 IN SpellList after RemoveFriendlyNano 270542 (remove flag 01).
        private static readonly byte[] PhasefrontCamoRemoveWire = MorphCaptureWireCatalog.GetWire(270542, true);

        // Capture 20260806-085523 IN SpellList "Phasefront Loungemaster - The Executive".
        private static readonly byte[] PhasefrontExecutiveApplyWire = MorphCaptureWireCatalog.GetWire(288546, false);

        // Capture 20260806-085523 IN SpellList remove for Executive (remove flag 01).
        private static readonly byte[] PhasefrontExecutiveRemoveWire = MorphCaptureWireCatalog.GetWire(288546, true);

        private static readonly byte[] CanFlyEffectBlock = MorphCaptureWireCatalog.GetCanFlyEffectBlock();
