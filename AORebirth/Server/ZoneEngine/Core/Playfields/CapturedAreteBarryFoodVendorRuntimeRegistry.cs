namespace ZoneEngine.Core.Playfields
{
    ...
    internal static class CapturedAreteBarryFoodVendorRuntimeRegistry
    {
        private static readonly object Sync = new object();

        private static readonly Dictionary<int, CapturedAreteBarryFoodVendorRuntimeDefinition> Entries =
            new Dictionary<int, CapturedAreteBarryFoodVendorRuntimeDefinition>();

        internal static void Register(CapturedAreteBarryFoodVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
        ...
        internal static bool TryGet(int npcInstance, out CapturedAreteBarryFoodVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
    ...
    internal sealed class CapturedAreteBarryFoodVendorRuntimeDefinition
    {
        internal CapturedAreteBarryFoodVendorRuntimeDefinition(
