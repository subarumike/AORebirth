namespace ZoneEngine.Core.Playfields
{
    ...
    internal static class CapturedAreteRemiGalloisVendorRuntimeRegistry
    {
        private static readonly object Sync = new object();

        private static readonly Dictionary<int, CapturedAreteRemiGalloisVendorRuntimeDefinition> Entries =
            new Dictionary<int, CapturedAreteRemiGalloisVendorRuntimeDefinition>();

        internal static void Register(CapturedAreteRemiGalloisVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
        ...
        internal static bool TryGet(int npcInstance, out CapturedAreteRemiGalloisVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
    ...
    internal sealed class CapturedAreteRemiGalloisVendorRuntimeDefinition
    {
        internal CapturedAreteRemiGalloisVendorRuntimeDefinition(
