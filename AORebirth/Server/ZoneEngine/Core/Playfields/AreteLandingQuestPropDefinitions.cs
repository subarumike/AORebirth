namespace ZoneEngine.Core.Playfields
{
    ...
    /// Gas fires: AreteGasFireRuntime (capture 20260731-162309 + Marcus pad extinguish/respawn).
    ...
    internal static class AreteLandingQuestPropDefinitions
    {
            ...
            IEnumerable<PlayfieldStaticDynelDefinition> existing)
        {
            ...
            foreach (PlayfieldStaticDynelDefinition gasFire in AreteGasFireRuntime.EnumerateDefinitions())
            {
                if (gasFire == null || existingKeys.Contains(gasFire.Identity.Long()))
                {
                    continue;
                }

                spawned++;
                yield return gasFire;
            }
