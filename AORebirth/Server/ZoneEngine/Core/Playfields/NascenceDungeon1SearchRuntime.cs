namespace AORebirth.Core.Playfields
{
    ...
    /// </summary>
    internal static class NascenceDungeon1SearchRuntime
    {
        ...
        internal static bool TryHandleSearch(ZoneClient client, ICharacter character)
        {
            ...
            string[] minePackets = NascenceDungeon1DoorCapture.ZoneInMinePacketHex;
            ...
            ReplaceInstance(minePacket, NascenceDungeon1DoorCapture.CapturedCharacterInstance, characterInstance);
            ReplaceInstance(minePacket, NascenceDungeon1DoorCapture.CapturedPlayfieldId, playfieldInstance);
            ReplaceInstance(minePacket, NascenceDungeon1Rules.LegacyCapturedPlayfieldId, playfieldInstance);
            ReplaceInstance(minePacket, NascenceDungeon1Rules.ReservedDungeonPlayfieldId, playfieldInstance);
            ReplaceInstance(minePacket, NascenceDungeon1Rules.DungeonPlayfieldId, playfieldInstance);
