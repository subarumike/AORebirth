namespace ZoneEngine.Core.Playfields
{
    ...
    internal static class CapturedAreteLoreleiVendorRuntimeRegistry
    {
        private static readonly object Sync = new object();

        private static readonly Dictionary<int, CapturedAreteLoreleiVendorRuntimeDefinition> Entries =
            new Dictionary<int, CapturedAreteLoreleiVendorRuntimeDefinition>();

        internal static void Register(CapturedAreteLoreleiVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
        ...
        internal static bool TryGet(int npcInstance, out CapturedAreteLoreleiVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
    ...
    internal sealed class CapturedAreteLoreleiVendorRuntimeDefinition
    {
        internal CapturedAreteLoreleiVendorRuntimeDefinition(
