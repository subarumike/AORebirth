namespace ZoneEngine.Core.Playfields
{
    ...
    internal static class CapturedAreteMarcoSpidaVendorRuntimeRegistry
    {
        private static readonly object Sync = new object();

        private static readonly Dictionary<int, CapturedAreteMarcoSpidaVendorRuntimeDefinition> Entries =
            new Dictionary<int, CapturedAreteMarcoSpidaVendorRuntimeDefinition>();

        internal static void Register(CapturedAreteMarcoSpidaVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
        ...
        internal static bool TryGet(int npcInstance, out CapturedAreteMarcoSpidaVendorRuntimeDefinition runtime)
        {
            lock (Sync)
            {
    ...
    internal sealed class CapturedAreteMarcoSpidaVendorRuntimeDefinition
    {
        internal CapturedAreteMarcoSpidaVendorRuntimeDefinition(
