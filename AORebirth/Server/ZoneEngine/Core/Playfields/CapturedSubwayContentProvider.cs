        ...
        public CapturedSubwayLootDefinition[] GetLootDefinitions()
        {
            ...
            return new[]
            {
                ...
                new CapturedSubwayLootDefinition(
                    ...
                    OrdinaryEnemyLootLinkageEvidence.ProvenEnemyCorpseItem,
                    OrdinaryEnemyLootProbabilityEvidence.ExistingCapturePolicy,
                    "20260708-004038:SimpleChar:794AD9A9>Corpse:F6E007>InventoryUpdate#8496"),
                new CapturedSubwayLootDefinition(
                    "Filth Flea",
                    17657,
                    138,
                    ...
                    OrdinaryEnemyLootLinkageEvidence.ProvenEnemyCorpseItem,
                    OrdinaryEnemyLootProbabilityEvidence.ExistingCapturePolicy,
                    "20260708-004038:SimpleChar:794ADBC4>Corpse:F6E01E>InventoryUpdate#9216"),
                new CapturedSubwayLootDefinition(
                    "Filth Flea",
                    17657,
                    138,
                ...
                new CapturedSubwayLootDefinition(
                    ...
                    OrdinaryEnemyLootLinkageEvidence.ProvenEnemyCorpseItem,
                    OrdinaryEnemyLootProbabilityEvidence.ExistingCapturePolicy,
                    "20260708-004038:SimpleChar:794ADC0B>Corpse:F6E002>InventoryUpdate#9996"),
                new CapturedSubwayLootDefinition(
                    "Filth Flea",
                    17657,
                    138,
                    ...
                    OrdinaryEnemyLootLinkageEvidence.ProvenEnemyCorpseItem,
                    OrdinaryEnemyLootProbabilityEvidence.ExistingCapturePolicy,
                    "20260712-155528:SimpleChar:795F91B9>Corpse:F6C003>InventoryUpdate#742"),
                new CapturedSubwayLootDefinition(
                    "Filth Flea",
                    17657,
                    138,
                    ...
                    OrdinaryEnemyLootLinkageEvidence.ProvenEnemyCorpseItem,
                    OrdinaryEnemyLootProbabilityEvidence.ExistingCapturePolicy,
                    "20260712-161506:SimpleChar:795F924E>Corpse:F6C00B>InventoryUpdate#172"),
                new CapturedSubwayLootDefinition(
                    "Disobedient Bot",
                    17649,
                    138,
