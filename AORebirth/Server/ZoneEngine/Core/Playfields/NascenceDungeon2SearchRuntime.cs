namespace AORebirth.Core.Playfields
{
    ...
    /// </summary>
    internal static class NascenceDungeon2SearchRuntime
    {
        ...
        internal static bool TryHandleSearch(ZoneClient client, ICharacter character)
        {
            ...
            string[] minePackets = NascenceDungeon2DoorCapture.ZoneInMinePacketHex;
            ...
            ReplaceInstance(minePacket, NascenceDungeon2DoorCapture.CapturedCharacterInstance, characterInstance);
            ReplaceInstance(minePacket, NascenceDungeon2DoorCapture.CapturedPlayfieldId, playfieldInstance);
            ReplaceInstance(minePacket, NascenceDungeon2Rules.DungeonPlayfieldId, playfieldInstance);
