...
// AUTO from capture 20260719-5-different-shape-fo-mish
        ...
        new MissionShape
        {
            ...
            SpawnX = 298.198975f, SpawnY = 5.01f, SpawnZ = 115.01001f,
            Npcs = new[]
            {
                new MissionNpc
                {
        ...
        new MissionShape
        {
            ...
            SpawnX = 298.198975f, SpawnY = 5.01f, SpawnZ = 145.01001f,
            Npcs = new[]
            {
                new MissionNpc
                {
    ...
    internal static class MissionInstanceLootCatalog
    {
        ...
        {
            new LootDrop { MonsterData = 26137, LowId = 130209, HighId = 130210, Quality = 154 },
            new LootDrop { MonsterData = 26135, LowId = 142916, HighId = 142917, Quality = 137 },
            new LootDrop { MonsterData = 26090, LowId = 121905, HighId = 121906, Quality = 127 },
            new LootDrop { MonsterData = 26139, LowId = 101406, HighId = 101334, Quality = 146 },
        };
