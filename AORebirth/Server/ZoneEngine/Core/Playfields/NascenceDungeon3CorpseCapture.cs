namespace AORebirth.Core.Playfields
{
    ...
    /// <summary>
    /// Capture 20260830-140240 CorpseFullUpdate for Nascence Dungeon 3 mobs.
    /// Templates reuse D2 layout where MDs overlap; gated by NascenceDungeon3Rules.IsDungeonPlayfield.
    /// </summary>
    internal static class NascenceDungeon3CorpseCapture
    {
        ...
        // Capture 20260830-140240 Remains of Mortiig Predator (MD 209395, catMesh 209295).
        ...
        // Capture 20260830-140240 Remains of Guard Turret (MD 209712, catMesh 205693).
        ...
        // Capture 20260830-140240 Remains of Hued Sewer Scuttler (MD 22794, catMesh 22773).
        ...
        // Capture 20260830-140240 Remains of Havaris (MD 212846, catMesh 210952).
            ...
            int corpseCredits)
        {
            if (deadNpc == null
                ...
                || !NascenceDungeon3Rules.IsDungeonPlayfield(deadNpc.Playfield.Identity.Instance))
            {
                return null;
            }
