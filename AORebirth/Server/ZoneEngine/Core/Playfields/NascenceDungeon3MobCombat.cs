namespace ZoneEngine.Core.Playfields
{
    ...
    /// <summary>
    /// Capture-backed 5m automatic aggro for Nascence Dungeon 3 mobs.
    ...
    /// </summary>
    internal static class NascenceDungeon3MobCombat
    {
        ...
        // Capture 20260830-140240 Mortiig Predator 7A416AA5 engage SAW (not mission SIW1).
        ...
        /// <summary>
        /// Capture 20260830-140240: SpecialAttackWeapon QTCC/BHMI/DRNY/UVKM/VYDD + Attack once per engage.
        ...
        internal static bool TryPrepareMortiigCombat(Character mob, NPCController controller, int level)
        {
            ...
            CapturedEnemyCombatContract contract = CapturedEnemyCombatContract.CapturedFixedPacketSequence(
                "nascence-d3-mortiig-20260830-140240",
        ...
        internal static bool ShareAggroRoom(ICharacter npc, ICharacter player)
        {
            ...
            if (NascenceDungeon3RevealZones.ResolveZoneKey(nx, nz)
        ...
        private static void EnsureDoorBlockers()
        {
            ...
            lock (DoorGate)
            {
                ...
                string[] hexList = NascenceDungeon3DoorCapture.ZoneInDoorPacketHex;
                for (int i = 0; i < hexList.Length; i++)
                {
                    float x;
                    float y;
                    float z;
                    if (!NascenceDungeon3RevealZones.TryParseWorldPosition(hexList[i], out x, out y, out z))
                    {
                        continue;
                    }
        ...
        internal static ICharacter FindAutomaticAggroTarget(ICharacter npc)
        {
            ...
            if (!NascenceDungeon3Rules.IsDungeonPlayfield(npc.Playfield.Identity.Instance))
            {
                return null;
            }
