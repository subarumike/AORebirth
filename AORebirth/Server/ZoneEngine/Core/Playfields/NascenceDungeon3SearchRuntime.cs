namespace AORebirth.Core.Playfields
{
    ...
    /// </summary>
    internal static class NascenceDungeon3SearchRuntime
    {
        ...
        internal static bool TryHandleSearch(ZoneClient client, ICharacter character)
        {
            ...
            string[] minePackets = NascenceDungeon3DoorCapture.ZoneInMinePacketHex;
            ...
            ReplaceInstance(minePacket, NascenceDungeon3DoorCapture.CapturedCharacterInstance, characterInstance);
            ReplaceInstance(minePacket, NascenceDungeon3DoorCapture.CapturedPlayfieldId, playfieldInstance);
            ReplaceInstance(minePacket, NascenceDungeon3Rules.DungeonPlayfieldId, playfieldInstance);
