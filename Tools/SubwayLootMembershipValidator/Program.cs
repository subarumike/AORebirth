namespace SubwayLootMembershipValidator
{
    using System;
    ...
    internal static class Program
    {
        private static int Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("SUBWAY_LOOT_AUDIT_ITEMS=" + rows.Length);
                Console.WriteLine(
                    "SUBWAY_LOCAL_ITEM_TEMPLATES_RESOLVED=" + sourceIds.Length);
                Console.WriteLine("SUBWAY_LOOT_MEMBERSHIP_SOURCE_AUDITED=YES");
                return 0;
            }
            catch (Exception error)
            {
                Console.Error.WriteLine("SUBWAY_LOOT_MEMBERSHIP_VALIDATION=FAIL");
