namespace AORebirth.Tools.CharacterDaoValidation
{
    ...
    {
        private const string Container = "aorebirth-character-dao-validation";
        private const string Network = "aorebirth_character_dao_validation_internal";
        private const string Volume = "aorebirth_character_dao_validation_data";
        private const string Database = "aorebirth_character_dao_validation";
        private const string User = "aorebirth_character_validation";
        private const string Label = "org.aorebirth.character-dao-run";
        private const string Image = "mysql@sha256:c592c15aaf4a1961e15d82eb31ea5987dda862d1c4b1e93424438c0e91dc1f8d";
        private const uint Port = 33071;
        ...
        internal static DisposableMySql Create()
        {
            ...
            try
            {
                ...
                fixture.environmentFile = Path.Combine(Path.GetTempPath(), "aorebirth-character-dao-" + fixture.run + ".env");
        ...
        internal MySqlConnection WaitForReady()
        {
            ...
            Console.Error.WriteLine("CHARACTER_DAO_STARTUP_LAST_ERROR=" + (last == null ? "none" : last.GetType().Name));
            if (last is MySqlException) Console.Error.WriteLine("CHARACTER_DAO_STARTUP_MYSQL_NUMBER=" + ((MySqlException)last).Number);
        ...
        public void Dispose()
        {
            ...
            Console.WriteLine("CHARACTER_DAO_DISPOSABLE_CLEANUP=" + (clean ? "PASS" : "FAIL"));
