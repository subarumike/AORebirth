    ...
    internal static class Connector
    {
        ...
        public static IDbConnection GetConnection()
        {
            if (TestConnectionFactory == null)
                throw new InvalidOperationException("Character tests require an explicit disposable factory.");
...
namespace Utility
{
    ...
    internal static class LogUtil
    {
        ...
        {
            ErrorCount++;
            Console.Error.WriteLine("CHARACTER_TEST_HOST_LOG=" + exception.GetType().Name);
        }
    }
}
