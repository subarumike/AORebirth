...
def main(argv=None):
    ap=argparse.ArgumentParser(); ap.add_argument("--validate",action="store_true"); ap.add_argument("--dump"); ap.add_argument("--output",default="docs/generated/enemy_catalog")
