...
namespace aorf
{
    namespace
    {
        constexpr size_t CallsiteCount = 5;
        ...
        {
            {
                ...
                { 0x157BC, 0x16144, 0x168E2, 0x168F6, 0x16F98 },
                0xE095,
                0x3AAEA,
                0x5F894,
                0x5F8EC,
            ...
            },
            {
                ...
                { 0x13F2E, 0x148B6, 0x15054, 0x15068, 0x1570A },
                0xC8AA,
                0x3894A,
                0x5B80C,
                0x5B864,
    ...
    bool InstallRoomSpaceFix()
    {
        ...
        if (protectionsRestored && threadsResumed)
        {
            Log(
                ...
                "callRvas=0x%X,0x%X,0x%X,0x%X,0x%X",
                profile->name,
                profile->sha256,
