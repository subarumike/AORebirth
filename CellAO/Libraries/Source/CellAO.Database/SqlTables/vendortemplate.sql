...
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCWepB', 1, 'Basic ICC Weapons', 297430, 'IGNO', 1, 109, 0.04, 1.05, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCWepA', 1, 'Advanced ICC Weapons', 297431, 'IGNO', 110, 209, 0.04, 1.05, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCWepS', 1, 'Superior ICC Weapons', 297432, 'IGNO', 210, 249, 0.04, 1.05, 161);
