...
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCAccB', 1, 'Basic ICC Accessories', 297424, 'AcB', 1, 300, 0.04, 1.05, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCAccA', 1, 'Advanced ICC Accessories', 297425, 'AcA', 1, 300, 0.04, 1.05, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCAccS', 1, 'Superior ICC Accessories', 297426, 'AcS', 1, 300, 0.04, 1.05, 161);
...
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCArmA', 1, 'Advanced ICC Armor', 297428, 'IAA', 100, 209, 0.04, 1.05, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCArmS', 1, 'Superior ICC Armor', 297429, 'IAS', 175, 249, 0.04, 1.05, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCWepB', 1, 'Basic ICC Weapons', 297430, 'WpB', 1, 300, 0.04, 0.56, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCWepA', 1, 'Advanced ICC Weapons', 297431, 'WpA', 1, 300, 0.04, 0.56, 161);
insert into `vendortemplate` (`HASH`,`lvl`,`Name`,`itemtemplate`,`ShopInvHash`,`minQL`,`maxQL`,`buy`,`sell`,`skill`) VALUES ('ICCWepS', 1, 'Superior ICC Weapons', 297432, 'WpS', 1, 300, 0.04, 0.56, 161);
