...
- Finalized official-live capture `20260719-021022` adds source-specific complete
  ...
  partially quarantined and source `0x7953AFA1` keeps its active disposition.
...
- Finalized official-live capture `20260719-020104` adds an exact four-segment
  ...
  landed local-player damage and therefore remains quarantined despite its exact
  source patrol and 14 strict loot outcomes (`13` positive, `1` empty). This
