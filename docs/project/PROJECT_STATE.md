...
- Regular loot-bearing corpses receive a five-minute initial lifetime. Empty corpses and fully looted corpses use the 30-second cleanup window; this protects ordinary enemy loot, including the first-room Subway Thief's guaranteed QL1 Stolen Handbag, without leaving unlooted corpses indefinitely.
