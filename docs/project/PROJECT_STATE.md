...
- First-room Subway Thief behavior has been reintroduced as a bounded slice: captured patrol replay from `20260710-205400`, exact Thief corpse eligibility, QL1 Stolen Handbag corpse loot, and 60-second respawn. The handbag mission chain remains deferred until separately selected and validated.
