...
- Loot-bearing corpse access preserves close-and-reopen semantics for the corpse lifetime. Repeated use always resends the captured inventory contents and supplements already-opened corpses with the client access action, without consuming remaining loot or changing the five-minute regular-corpse lifetime.
