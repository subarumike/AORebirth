...
- Completed Thief capture `20260710-205400` extends the existing single Thief without adding a duplicate: its repeated eight-leg patrol is replayed, its stable SCFU appearance value is `1576`, and it respawns `60` seconds after dead-NPC despawn.
