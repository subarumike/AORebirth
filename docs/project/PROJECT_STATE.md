...
- Premature Pattern source `79545356` now preserves the two exact same-source generations joined from captures `20260709-225408` and `20260712-232848`: L17/368 HP/scale 98/RunSpeed 65 and L18/394 HP/scale 98/RunSpeed 68. It also follows the complete reviewed out-and-back patrol. The variants intentionally have no weapon because neither capture contains a complete weapon update; uniform selection is private policy, no extra population row was added, and PF127 remains 321 total/321 active/zero quarantined.
