...
Automatic and manual recovery use the same guarded command. Service configuration,
lock locations and operator commands are maintained in the private operations
repository. Credentials are never written to recovery output.
