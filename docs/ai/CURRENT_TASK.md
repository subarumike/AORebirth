...
Subway PF127 + Temple of Three Winds continue on master. PF647 is the Temple transfer/gateway; PF1931 owns the dungeon rooms, population, and loot, now including Guardian of Tomorrow, Gartua the Doorkeeper, and 22 added main-room Cultist anchors. Uklesh and the remaining named main-room actors are evidence-only. See `docs/project/PROJECT_STATE.md` and TOTW evidence docs for that track.
