...
The supported Arete combat cohort remains unchanged. Engineer Automaton I,
Robotic Guard Dog, and incomplete robot variants remain quarantined where exact
combat evidence is absent; patrol movement remains outside that completed slice.
...
- Preserve the governed generated combat cohort and all evidence-backed
  quarantine rules.
- Original-client Linux end-to-end and multiplayer acceptance remain manual,
  explicit gates; do not launch the AO client without current authorization.
