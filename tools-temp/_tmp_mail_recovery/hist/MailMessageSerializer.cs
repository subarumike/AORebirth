...
namespace SmokeLounge.AOtomation.Messaging.Serialization.Serializers.Custom
{
    ...
    /// Empty list: X3F1 count word 0x000003F1 (capture 20260714-182726).
    /// Non-empty: (count+1)*0x03F1 then MailMessage entry wire (0x10125ec5).
    /// </summary>
    public class MailMessageSerializer : ISerializer
    {
        ...
        private static void WriteMailListEntry(StreamWriter streamWriter, MailListEntry entry)
        {
            ...
            // BinaryStream << unsigned __int64 (Gamecode IAT).
            ...
            // Summary byte: 1 = inbox row without body/item; 0 = full message.
            ...
            // Full form omitted for inbox listing; ACGItem wire required for attached items.
            streamWriter.WriteInt32(entry.ExtendedField64);
            streamWriter.WriteInt32(entry.ItemType);
            streamWriter.WriteInt32(entry.ItemInstance);
            streamWriter.WriteInt32(entry.ItemExtra);
        ...
        private static MailListEntry ReadMailListEntry(StreamReader streamReader)
        {
            ...
            entry.ItemType = streamReader.ReadInt32();
            entry.ItemInstance = streamReader.ReadInt32();
            entry.ItemExtra = streamReader.ReadInt32();
