namespace ZoneEngine.Core
{
    ...
    /// <summary>
    /// Online player resolve for LFT/team. No Level quiet / Despawn / InfoPacket hacks.
    /// LFT list filters by XP window in ChatEngine (TeamLevelRanges.IsCompatible).
    /// In-range invites should not pop the client XP warn.
    /// </summary>
