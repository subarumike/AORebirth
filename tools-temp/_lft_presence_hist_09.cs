namespace ZoneEngine.Core
{
    ...
    /// Do NOT Despawn or Stat-lie Level/GM — that hid players and forced Level=1.
    /// Warn suppress reverted; invite still only on client 0x1A.
    /// </summary>
    public static class LftInviteClientPresence
    {
        ...
        {
            // No-op: Despawn/Level=1 SCFU broke visibility and levels.
        }
        ...
        /// <summary>No-op — previous Stat/SCFU/Despawn seed corrupted client view.</summary>
