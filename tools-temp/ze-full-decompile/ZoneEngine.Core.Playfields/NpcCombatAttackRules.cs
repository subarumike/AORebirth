...
public static class NpcCombatAttackRules
{
	...
	public const int CapturedCleaningRobotLeftWeaponTemplate = 125280;

	public const int CapturedCleaningRobotRightWeaponTemplate = 125277;

	public const int CapturedCleaningRobotLeftWeaponTag = 1279874866;

	public const int CapturedCleaningRobotRightWeaponTag = 1279874865;
	...
	public const int CapturedSubwayDiscardedPetWeaponTag = 1397315377;
	...
	public const int CapturedSubwayDisobedientBotLowTemplate = 144742;

	public const int CapturedSubwayDisobedientBotHighTemplate = 144743;

	public const int CapturedSubwayDisobedientBotWeaponTag = 1397315377;
	...
	public const double CapturedSubwayBloodcreeperBiteRechargeSeconds = 7.50984;
	...
	public const int CapturedSubwayBloodcreeperBiteTag = 1397446449;
	...
	public const int CapturedSubwayBloodcreeperSpitTag = 1397446450;
	...
	public const double CapturedSubwayVergilMovementTransitionDelaySeconds = 0.001;

	public const double CapturedSubwayVergilFirstHitDelaySeconds = 2.78741;
	...
	public const double CapturedSubwayEumenidesAttackStartDelaySeconds = 0.001;
	...
	public const int CapturedSubwayAbmouthXopzTag = 1481592922;
	...
	public const int CapturedSubwayAbmouthDenwTag = 1145392727;
	...
	public const int CapturedSubwayAbmouthInfectorTag = 1145919558;
	...
	public const int CapturedSubwayFilthFleaStickToHeadTag = 1162887496;
	...
	public const int CapturedSubwayFilthFleaArmsTag = 1096439123;
	...
	public static bool ShouldSendCapturedCleaningRobotAttackStartContext(bool isCapturedCleaningRobot, bool usesEquippedWeapon, int? previousTargetInstance, int targetInstance)
	{
		return isCapturedCleaningRobot && !usesEquippedWeapon && (!previousTargetInstance.HasValue || previousTargetInstance.Value != targetInstance);
	}

	public static bool ShouldSendPlayerOwnedAttackPetAttackStartContext(bool isPlayerOwnedAttackPet, int? previousTargetInstance, int targetInstance)
	{
		return isPlayerOwnedAttackPet && (!previousTargetInstance.HasValue || previousTargetInstance.Value != targetInstance);
	}
}
