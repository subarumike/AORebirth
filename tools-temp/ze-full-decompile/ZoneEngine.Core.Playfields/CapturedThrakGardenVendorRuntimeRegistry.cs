...
internal static class CapturedThrakGardenVendorRuntimeRegistry
{
	...
	private static readonly Dictionary<int, CapturedThrakGardenVendorRuntimeDefinition> Entries = new Dictionary<int, CapturedThrakGardenVendorRuntimeDefinition>();
	...
	internal static void Register(CapturedThrakGardenVendorRuntimeDefinition runtime)
	{
		...
		lock (Sync)
		{
			Dictionary<int, CapturedThrakGardenVendorRuntimeDefinition> entries = Entries;
	...
	internal static bool ContainsPlayfield(Identity playfieldIdentity)
	{
		...
		lock (Sync)
		{
			return Entries.Values.Any((CapturedThrakGardenVendorRuntimeDefinition runtime) => Same(runtime.PlayfieldIdentity, playfieldIdentity));
		}
	}
