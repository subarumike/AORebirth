...
internal sealed class CapturedSubwayPatrolReplaySegment
{
	...
	public CapturedSubwayPatrolReplaySegment(double delayAfterSeconds, float startX, float startY, float startZ, float endX, float endY, float endZ, byte moveMode)
	{
