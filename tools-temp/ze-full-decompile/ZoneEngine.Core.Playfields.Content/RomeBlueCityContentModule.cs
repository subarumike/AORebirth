...
public sealed class RomeBlueCityContentModule : IPlayfieldContentModule
{
	...
	{
		return ((Identity)(ref playfieldIdentity)).Instance == 735;
	}
	...
	public void Register(PlayfieldContentRegistration registration)
	{
		...
		if (registration != null && Supports(registration.PlayfieldIdentity))
		{
			...
			LogUtil.Debug((DebugInfoDetail)128, "RomeBlueCityContentModule RegisterCapturedNpcSpawns pf=" + ((Identity)(ref playfieldIdentity)).Instance);
