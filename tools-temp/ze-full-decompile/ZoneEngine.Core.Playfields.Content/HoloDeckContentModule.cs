...
public sealed class HoloDeckContentModule : IPlayfieldContentModule
{
	...
	{
		return ((Identity)(ref playfieldIdentity)).Instance == 7001;
	}
	...
	public void Register(PlayfieldContentRegistration registration)
	{
		...
		if (registration != null && Supports(registration.PlayfieldIdentity))
		{
			...
			LogUtil.Debug((DebugInfoDetail)128, "HoloDeckContentModule RegisterCapturedNpcSpawns pf=" + ((Identity)(ref playfieldIdentity)).Instance);
