...
{
	public const int CharDcMoveIirKey = 1410404643;

	public const int RelocateDynelsIirKey = 642470219;

	public const int DropDynelIirKey = 1195914803;
	...
	public static EnemyBehaviorTransition Apply(EnemyBehaviorState current, EnemyBehaviorSignal signal)
	{
		...
		case EnemyBehaviorSignal.AddThreat:
			return (current == EnemyBehaviorState.Idle) ? new EnemyBehaviorTransition(EnemyBehaviorState.Aggroed, "threat-added") : new EnemyBehaviorTransition(current, "threat-kept");
		...
		case EnemyBehaviorSignal.HealthDamage:
			return (current == EnemyBehaviorState.Dead) ? new EnemyBehaviorTransition(current, "dead") : new EnemyBehaviorTransition(EnemyBehaviorState.InRangeAttacking, "combat-result");
