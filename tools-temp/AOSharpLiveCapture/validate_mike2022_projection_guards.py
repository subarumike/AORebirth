...
def main():
    ...
    requirements = {
        ...
        "SCFU maximum life mapping": 'Stat = "Life", StatId = 1, Value = decoded.Health }',
        "SCFU current health mapping": 'Stat = "Health", StatId = 27, Value = Math.Max(0, decoded.Health - decoded.HealthDamage) }',
