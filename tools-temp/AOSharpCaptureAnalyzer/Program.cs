namespace AOSharpCaptureAnalyzer
{
    ...
    internal static class Program
    {
        ...
        // Capture 20260722-152454, packets.hex.log sequence 12626.
        private const string AreteGarbageFleaBd3PacketHex =
            "";

        // Capture 20260722-152454, packets.hex.log sequence 62905.
        private const string AretePacify7e2PacketHex =
            "";

        // Capture 20260722-152454, packets.hex.log sequence 62906.
        private const string AretePacifyBd3PacketHex =
            "";
        ...
        private static int Main(string[] args)
        {
            ...
            if (args.Length == 6
                && string.Equals(
                    ...
                    StringComparison.Ordinal))
            {
                return ItemTemplateProjection.Run(
                    args[1],
                    args[2],
                    args[3],
                    args[4],
        ...
        private static int RunSelfTest()
        {
            try
            {
                ...
                RawSimpleCharFullUpdate areteGarbageFleaBd3 =
                    RawSimpleCharFullUpdateDecoder.DecodePacket(
                        FromHex(AreteGarbageFleaBd3PacketHex));
                Assert(
                    areteGarbageFleaBd3.DecodeFullyConsumed,
                    "Observed Arete flags2 BD3 LEW extension fully decoded");
                AssertEqual(
                    18,
                    areteGarbageFleaBd3.OpaqueExtension.Length,
                    "Observed Arete flags2 BD3 LEW extension length");

                RawSimpleCharFullUpdate aretePacify7e2 =
                    RawSimpleCharFullUpdateDecoder.DecodePacket(
                        FromHex(AretePacify7e2PacketHex));
                Assert(
                    aretePacify7e2.DecodeFullyConsumed,
                    "Observed Arete flags2 7E2 extension fully decoded");
                AssertEqual(
                    6,
                    aretePacify7e2.OpaqueExtension.Length,
                    "Observed Arete flags2 7E2 extension length");

                RawSimpleCharFullUpdate aretePacifyBd3 =
                    RawSimpleCharFullUpdateDecoder.DecodePacket(
                        FromHex(AretePacifyBd3PacketHex));
                Assert(
                    aretePacifyBd3.DecodeFullyConsumed,
                    "Observed Arete flags2 BD3 MEW extension fully decoded");
                AssertEqual(
                    22,
                    aretePacifyBd3.OpaqueExtension.Length,
                    "Observed Arete flags2 BD3 MEW extension length");
